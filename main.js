...
function selectOption(){
    ...
    function calculateBMI(){
            ...
            var kg = weightElm.value;

            var cmValue = heightCentimeterEl.value;

            var feetValue = heightFeetEl.value;
            ...
            bmiValueCentimeter = (kg / meterSqrCenti).toFixed(1);
                ...
                if(kg === '' || kg == 0 || cmValue == '' || cmValue == 0 || bmiValueCentimeter === 'Infinity' || bmiValueCentimeter === 'NaN'){
                    //optEml.innerHTML = `BMI = 0`;
                ...
                if(kg === '' || kg == 0 || feetValue == '' || feetValue == 0|| bmiValueFeet === 'Infinity' || bmiValueFeet === 'NaN'){
                    //optEml.innerHTML = `BMI = 0`;
                    optMsgEml.innerHTML = `Please enter a valid input.`;
